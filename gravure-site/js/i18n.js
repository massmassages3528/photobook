...
// ─── Helpers ──────────────────────────────────────────────────────────────────
export const fontFamily = (lang) =>
  lang === 'ko' ? "'Noto Sans KR', sans-serif"
  : lang === 'zh' ? "'Noto Serif TC', serif"
  : "'Cormorant Garamond', serif";

export const idolName  = (idol, lang) =>
  lang === 'zh' ? idol.nameZh : lang === 'ko' ? idol.nameKo : idol.nameEn;

export const idolTitle = (idol, lang) =>
  lang === 'zh' ? idol.titleZh : lang === 'ko' ? idol.titleKo : idol.titleEn;
